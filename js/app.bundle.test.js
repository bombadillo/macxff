...
},{"./_vendor/qunit":1,"./common/eventChannel":3,"./common/globals":4,"./common/router":5,"./common/utilities":6,"./models/global":7,"backbone":14,"jquery":15}],3:[function(require,module,exports){
/* Require modules */
var $        = require('jquery'),
    Backbone = require('backbone'),
...
},{"../common/globals":4,"../common/utilities":6,"../views/feed":11,"../views/nav":12,"../views/search":13,"backbone":14,"jquery":15}],6:[function(require,module,exports){
// Set the object as the module exports
module.exports = {
...
with(obj||{}){
__p+='<div class="list-group sep-top">';
 _.each(feedItems, function (item) { 
__p+='<a href="'+
((__t=( item.link ))==null?'':__t)+
'" class="list-group-item active"><div class="row"><div class="col-xs-1"><img src="'+
((__t=( item.image.url ))==null?'':__t)+
'"></div><div class="col-xs-11"><h4 class="list-group-item-heading">'+
((__t=( item.title ))==null?'':__t)+
'</h4><p class="list-group-item-text">'+
((__t=( item.description ))==null?'':__t)+
'</p></div></div></a> ';
 }); 
__p+='</div><div class="col-xs-12 text-center"><ul class="pagination"><li><a href="javascript:void(0)" data-page-move="back">&laquo;</a></li>';
 for (var i = 0; i < numPages; i++) { 
__p+='<li class="'+
((__t=( i === currentPage - 1 ? 'active' : '' ))==null?'':__t)+
'"><a href="javascript:void(0)" data-page-number="'+
((__t=( i + 1 ))==null?'':__t)+
'">'+
((__t=( i + 1 ))==null?'':__t)+
'</a></li>';
 } 
__p+='<li><a href="javascript:void(0)" data-page-move="forward">&raquo;</a></li></ul></div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="col-xs-8 col-xs-offset-2 sep-top text-center">';
 _.each(feeds, function (feed) { 
__p+='<span class="feed-item label label-primary">'+
((__t=( feed ))==null?'':__t)+
'</span> ';
 }); 
__p+='</div>';
...
},{"../common/eventChannel":3,"../common/globals":4,"../common/utilities":6,"../models/global":7,"../templates/feed.html":8,"backbone":14,"jquery":15}],12:[function(require,module,exports){
/* Require modules */
var $        = require('jquery'),
    Backbone = require('backbone'),
    models   = require('../models/global'),
...
},{"../common/eventChannel":3,"../common/utilities":6,"../models/global":7,"../templates/nav.html":9,"backbone":14,"jquery":15}],13:[function(require,module,exports){
/* Require modules */
var $        = require('jquery'),
    Backbone = require('backbone'),
    models   = require('../models/global'),
...
},{"../common/eventChannel":3,"../common/utilities":6,"../models/global":7,"../templates/search.html":10,"backbone":14,"jquery":15}],14:[function(require,module,exports){
//     Backbone.js 1.1.2
